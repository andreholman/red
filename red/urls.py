...
urlpatterns = [
    ...
    path("s/<str:sub>/posts/<int:post_id>/vote/", views.post_vote, name="post_vote"), # POST
    ...
    path("s/<str:sub>/posts/<int:post_id>/commentvote/", views.comment_vote, name="comment_vote"), # POST
    path("s/<str:sub>/posts/<int:post_id>/commentupdate/", views.update_comment, name="update_comment"), # PUT
    path("s/<str:sub>/posts/<int:post_id>/commentdelete/", views.delete_comment, name="delete_comment"), # POST
