...
urlpatterns = [
    ...
    path("s/<str:sub>/posts/<int:post_id>/save/", views.post_save, name="post_save"), # PATCH
    ...
    path("s/<str:sub>/posts/<int:post_id>/commentsave/", views.comment_save, name="comment_save"), # PATCH
